...
export const chatModels: ChatModel[] = [
  ...
  },
  {
    ...
    name: "DeepSeek R1",
    provider: "DeepSeek",
    description: "Fastest variant of DeepSeek R1.",
    creditCost: 6,
  },
  {
    id: "deepseek-ai/DeepSeek-V3.2:fastest",
    name: "DeepSeek V3.2",
    provider: "DeepSeek",
    description: "Fastest variant of DeepSeek V3.2.",
    creditCost: 5,
  },
  {
    id: "deepseek-ai/DeepSeek-V3.1:fastest",
    name: "DeepSeek V3.1",
    provider: "DeepSeek",
    description: "Fastest variant of DeepSeek V3.1.",
    creditCost: 5,
  },
  {
    id: "deepseek-ai/DeepSeek-V3:fastest",
    name: "DeepSeek V3",
    provider: "DeepSeek",
    description: "Fastest variant of DeepSeek V3.",
    creditCost: 4,
  },
  {
  ...
  {
    id: "MiniMaxAI/MiniMax-M2.1:fastest",
    name: "MiniMax M2.1",
    provider: "MiniMax",
    description: "Fastest variant of MiniMax M2.1.",
    creditCost: 4,
  },
  {
    id: "MiniMaxAI/MiniMax-M2:fastest",
    name: "MiniMax M2",
    provider: "MiniMax",
    description: "Fastest variant of MiniMax M2.",
    creditCost: 3,
  },
  {
    ...
    name: "Mistral 0.2",
    provider: "Mistral",
    description: "Fastest variant of Mistral 7B Instruct v0.2.",
    creditCost: 3,
  },
  {
